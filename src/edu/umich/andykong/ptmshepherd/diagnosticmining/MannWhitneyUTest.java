...
/*
 * This is not the original file distributed by the Hipparchus project
 * It has been modified by danielgeiszler@github
 */
...
public class MannWhitneyUTest {
    ...
    public double mannWhitneyU2(final double[] x, final double[] y)
            throws MathIllegalArgumentException, NullArgumentException {
