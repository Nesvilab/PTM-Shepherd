...
public class SimRTAnalysis {
	...
	public boolean isComplete() {
		try {
			...
			PTMShepherd.die("Error writing to simRT file: " + simRTFile.getAbsolutePath());
		}
		return false;
	}
	...
	public void simrtPSMs(PSMFile pf, HashMap<String,File> mzMappings, boolean interRunComparisons) {
	...
	public void updateSimRTProfiles(SimRTProfile [] profiles) {
        try {
            ...
            PTMShepherd.die("Error updating simRT profiles in file " + simRTFile.getAbsolutePath() + "\n" + e.getMessage());
        }
    }
